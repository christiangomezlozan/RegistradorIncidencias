...
/**
 * Actualiza los datos de una incidencia existente en la base de datos
 * Los datos son obtenidos desde una solicitud POST al enviar el formulario de la página editaModal.php
 * @var $sql Consulta que se realiza a la base de datos tras validar los datos para actualizar la incidencia
 * 
 * @package incidencias
