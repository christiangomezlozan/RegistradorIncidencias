<?php
/**
 * Página modal que proporciona un formulario para modificar los datos de las incidencias que se están tratando
 * 
 * @package incidencias
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="actualizar.php" method="POST" id="actualizaIncidenciaForm" >
            ...
            <div class="mb-3">
                <label for="estado_gdia" class="form-label">Estado Gdia</label>
            ...
            <div class="mb-3">
                <label for="estado_vent" class="form-label">Estado Ventanilla</label>
