...
<body class="d-flex flex-column min-vh-100">
            ...
            <tbody>
                <?php while($incidencia = $incidencias->fetch_assoc()){ ?>
                    <tr>
                        ...
                        <td><?= obtenerTipologia($incidencia['tipologia']) ?></td>
    ...
    <script>
        ...
        editaModal.addEventListener('hide.bs.modal', event => { // Evento javascript para que una vez que se oculte el modal, se borren los datos
