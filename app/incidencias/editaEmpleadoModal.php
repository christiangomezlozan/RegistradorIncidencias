<?php
/**
 * Página modal que proporciona un formulario para modificar datos de empleados
 * 
 * @package incidencias
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editaEmpleadoModalLabel">Modificar empleado</h1>
